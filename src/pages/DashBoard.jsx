        ...
        <div className="min-h-screen w-full bg-[#eaecef]">
            ...
            <div className="h-[85vh] w-full flex flex-row flex-wrap justify-center items-center">
                <div className="h-full w-8/12 pt-5 flex flex-col bg-[#eaecef]">
                    <input type="text" value={gpa} onChange={(e) => setGpa(e.target.value)} placeholder="Enter Desired GPA" className='h-10 w-10/12 mx-auto px-4 py-6 border-solid border-2 border-gray-400 rounded-lg bg-white'/>
